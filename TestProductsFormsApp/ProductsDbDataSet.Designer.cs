            ...
            public string Article {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Article\' в таблице \'Products\' равно DBNull.", e);
                    }
                }
                set {
...
namespace TestProductsFormsApp.ProductsDbDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Article] = @Article, [Name] = @Name, [Price] = @Price, [Quantity] = @Quantity WHERE (([Id] = @Original_Id) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity));
SELECT Id, Article, Name, Price, Quantity FROM Products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TestProductsFormsApp.Properties.Settings.Default.ProductsDbConnectionString;
        }
        ...
        public virtual int Update(string Article, string Name, decimal Price, int Quantity, int Original_Id, decimal Original_Price, int Original_Quantity, int Id) {
            if ((Article == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Article, string Name, decimal Price, int Quantity, int Original_Id, decimal Original_Price, int Original_Quantity) {
            return this.Update(Article, Name, Price, Quantity, Original_Id, Original_Price, Original_Quantity, Original_Id);
        }
    }
